import { LockClosedIcon, LoginIcon, PencilAltIcon } from "@heroicons/react/outline";
...
export default function SingUp() {
  ...
  return (
    <>
      <div className="h-screen flex items-center justify-center sm:px-6 bg-brand-300">
        <div className="max-w-md w-full space-y-4">
          ...
          <div className="border rounded-md px-4 shadow-md shadow-slate-400 bg-gray-50">
                ...
                <div>
                  ...
                  >
                    <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                      <LoginIcon className="h-5 w-5 text-green-500 group-hover:text-green-400" aria-hidden="true" />
                    </span>
                    Cadastrar-me
                  </button>
                </div>
