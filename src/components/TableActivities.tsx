    ...
    <div>
      <div className="card">
        <DataTable value={data} responsiveLayout="scroll" >
          ...
          <Column field='initial_event' header='Início' filterField="date" dataType="date" body={dateInitial} ></Column>
          <Column field='next_event' header='Próximo' filterField="date" dataType="date" body={dateNext}></Column>
